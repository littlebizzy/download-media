...
* [Disable XML-RPC](https://wordpress.org/plugins/download-theme-littlebizzy/)
...
There is no settings page for this plugin as it aims to be as simple as possible.
